...
import { createCommunity, deleteCommunity, getAllCommunities, getCommunityById, updateCommunity,toggleAcceptRequest,sendRequest,getAllRequests, getMembers, leaderBoard } from "../controllers/communityController";
const communityRouter = Router();
communityRouter.get("/",checkUser,getAllCommunities);
communityRouter.get("/:id",checkUser,getCommunityById);
communityRouter.get("/leaderboard/:id",checkUser,leaderBoard);
communityRouter.get("/members/:id",checkUser,getMembers);
